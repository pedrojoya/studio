package es.iessaladillo.pedrojoya.pr113.api;
...
import es.iessaladillo.pedrojoya.pr113.Model.ACLField;
import es.iessaladillo.pedrojoya.pr113.Model.ACLPermisos;
import es.iessaladillo.pedrojoya.pr113.Model.Resultado;
import es.iessaladillo.pedrojoya.pr113.Model.Tarea;
import es.iessaladillo.pedrojoya.pr113.Model.TareaACL;
...
public class ApiService {
    ...
    public static class UsuarioLoggedInEvent {
        ...
        public UsuarioLoggedInEvent(Usuario usuario) {
            mUsuario = usuario;
        }
    ...
    public static class UsuarioSignedUpEvent {
        ...
        public UsuarioSignedUpEvent(Usuario usuario) {
            mUsuario = usuario;
        }
    ...
    public void login(String username, String password) {
        ...
        mApiClient.login(username, password, new Callback<Usuario>() {
            ...
            public void success(Usuario usuario, Response response) {
                ...
                mBus.post(new UsuarioLoggedInEvent(usuario));
            }
    ...
    public void signUp(UsuarioNuevo usuarioNuevo) {
        ...
        mApiClient.signUp(usuarioNuevo, new Callback<Usuario>() {
            ...
            public void success(Usuario usuario, Response response) {
                ...
                App.setUsuario(usuario);
                // Se envía al bus el evento de que se ha hecho el login correctamente.
                mBus.post(new UsuarioSignedUpEvent(usuario));
            }
