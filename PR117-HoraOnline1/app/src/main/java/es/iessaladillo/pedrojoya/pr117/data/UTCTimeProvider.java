...
public class UTCTimeProvider extends ContentProvider {
    private static final String TAG = UTCTimeProvider.class.getSimpleName();
    ...
    public static final String AUTHORITY = "es.iessaladillo.pedrojoya.pr117.provider";
    public static final String CONTENT_URI_BASE = "content://" + AUTHORITY;

    public static final String QUERY_NOTIFY = "QUERY_NOTIFY";
    public static final String QUERY_GROUP_BY = "QUERY_GROUP_BY";

    private static final int URI_TYPE_UTCTIME = 0;
    private static final int URI_TYPE_UTCTIME_ID = 1;
    ...
    static {
        URI_MATCHER.addURI(AUTHORITY, UtctimeColumns.TABLE_NAME, URI_TYPE_UTCTIME);
        URI_MATCHER.addURI(AUTHORITY, UtctimeColumns.TABLE_NAME + "/#", URI_TYPE_UTCTIME_ID);
    }
    ...
    public String getType(Uri uri) {
        ...
        switch (match) {
            case URI_TYPE_UTCTIME:
                return TYPE_CURSOR_DIR + UtctimeColumns.TABLE_NAME;
            case URI_TYPE_UTCTIME_ID:
                return TYPE_CURSOR_ITEM + UtctimeColumns.TABLE_NAME;
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        long rowId = mDBHelper.getWritableDatabase().insertOrThrow(table, null, values);
    ...
    public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        int res = mDBHelper.getWritableDatabase().update(queryParams.table, values, queryParams.selection, selectionArgs);
        String notify;
        if (res != 0 && ((notify = uri.getQueryParameter(QUERY_NOTIFY)) == null || "true".equals(notify))) {
            getContext().getContentResolver().notifyChange(uri, null);
        }
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        QueryParams queryParams = getQueryParams(uri, selection, null);
        int res = mDBHelper.getWritableDatabase().delete(queryParams.table, queryParams.selection, selectionArgs);
        String notify;
        if (res != 0 && ((notify = uri.getQueryParameter(QUERY_NOTIFY)) == null || "true".equals(notify))) {
            getContext().getContentResolver().notifyChange(uri, null);
        }
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        Cursor res = mDBHelper.getReadableDatabase().query(queryParams.tablesWithJoins, projection, queryParams.selection, selectionArgs, groupBy,
    ...
    private QueryParams getQueryParams(Uri uri, String selection, String[] projection) {
        ...
        switch (matchedId) {
            case URI_TYPE_UTCTIME:
            case URI_TYPE_UTCTIME_ID:
                res.table = UtctimeColumns.TABLE_NAME;
                res.tablesWithJoins = UtctimeColumns.TABLE_NAME;
                res.orderBy = UtctimeColumns.DEFAULT_ORDER;
                break;
