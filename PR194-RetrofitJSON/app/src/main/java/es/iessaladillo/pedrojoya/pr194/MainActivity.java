...
public class MainActivity extends AppCompatActivity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(es.iessaladillo.pedrojoya.pr194.R.layout.activity_main);
        initVistas();
    ...
    private void initVistas() {
        ListView lstAlumnos = (ListView) findViewById(es.iessaladillo.pedrojoya.pr194.R.id.lstAlumnos);
        if (lstAlumnos != null) {
            lstAlumnos.setEmptyView(findViewById(es.iessaladillo.pedrojoya.pr194.R.id.lblEmpty));
            // El adaptador inicialmente recibe una lista vacía.
            mAdaptador = new AlumnosAdapter(this, new ArrayList<Alumno>());
            lstAlumnos.setAdapter(mAdaptador);
        }
        swlPanel = (SwipeRefreshLayout) findViewById(es.iessaladillo.pedrojoya.pr194.R.id.swlPanel);
        if (swlPanel != null) {
    ...
    public void onLoaderReset(Loader<ArrayList<Alumno>> loader) {
        Log.d(getString(es.iessaladillo.pedrojoya.pr194.R.string.app_name), "onLoaderReset");
