...
public class MenuBottomSheetDialogFragment extends BottomSheetDialogFragment implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (getView() != null) {
            CoordinatorLayout.LayoutParams params = (CoordinatorLayout.LayoutParams) ((View) getView().getParent()).getLayoutParams();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.bsmenuLlamar:
                Toast.makeText(getContext(), getString(R.string.llamar_a, mAlumno.getNombre()), Toast.LENGTH_SHORT).show();
                dismiss();
                return true;
            case R.id.bsmenuMensaje:
                Toast.makeText(getContext(), getString(R.string.enviar_mensaje_a, mAlumno.getNombre()), Toast.LENGTH_SHORT).show();
                dismiss();
                return true;
            case R.id.bsmenuNotas:
                Toast.makeText(getContext(), getString(R.string.ver_notas_de, mAlumno.getNombre()), Toast.LENGTH_SHORT).show();
                dismiss();
                return true;
        }
        return false;
