...
public class MainFragment extends Fragment {
        ...
        if (frg != null) {
            ...
            if (v != null) {
                ...
                if (svScrollView != null) {
                    // Si la toolbar est� presente y el scroll corresponde al
                    // necesario cuando la toolbar no est� presente.
                    if (mIsToolbarShown) {
                    ...
                    // Si la toolbar no est� presente y hay un scroll menor
    ...
    // Traslada la cabecera a su posici�n original de manera que la toolbar
    // sea visible.
    public void onShow() {
        llCabecera.animate().cancel();
