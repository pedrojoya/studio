...
public class MainActivity extends AppCompatActivity implements BuscarAsyncTask.Callbacks,
        EcoAsyncTask.Callbacks {
    ...
    private void initVistas() {
        ...
        if (btnBuscar != null) {
            btnBuscar.setOnClickListener(view -> buscar());
        }
        Button btnEco = (Button) findViewById(R.id.btnEco);
        if (btnEco != null) {
            btnEco.setOnClickListener(view -> eco());
        }
    ...
    private boolean isConnectionAvailable() {
        ...
        ConnectivityManager gestorConectividad = (ConnectivityManager) getSystemService(
