...
class Helper extends SQLiteOpenHelper {
    ...
    private static final String TBL_ALUMNO_CREATE =
            "create table " + Instituto.Alumno.TABLA + "(" + Instituto.Alumno._ID
                    + " integer primary key autoincrement, " + Instituto.Alumno.NOMBRE
                    + " text not null, " + Instituto.Alumno.CURSO + " text not null, "
                    + Instituto.Alumno.TELEFONO + " text not null, " + Instituto.Alumno.DIRECCION
                    + " text);";
    private static final String TBL_ALUMNO_DROP = "drop table if exists " + Instituto.Alumno.TABLA;
