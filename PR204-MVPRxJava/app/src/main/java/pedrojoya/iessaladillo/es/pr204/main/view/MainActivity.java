...
import pedrojoya.iessaladillo.es.pr204.model.database.DB;
import pedrojoya.iessaladillo.es.pr204.model.entity.Alumno;


public class MainActivity extends AppCompatActivity implements MainAdapter
        .OnItemClickListener, MainAdapter.OnItemLongClickListener {
    ...
    private void configRecyclerView() {
        mAdaptador = new MainAdapter(DB.getInstance().getAlumnos());
