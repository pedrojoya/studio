...
public class MainActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        findViews();
        viewModel = ViewModelProviders.of(this, new MainActivityViewModelFactory(VolleyInstance
                .getInstance(this).getRequestQueue(), DATA_URL)).get(MainActivityViewModel.class);
        initViews();
