...
@LargeTest
public class RetainActivityTest {

    @Rule
    public final IntentsTestRule<RetainActivity> testRule = new IntentsTestRule<>(RetainActivity.class);

    @Test
    public void shouldStartMethodStartThisActivity() {
        RetainActivity.start(testRule.getActivity());
